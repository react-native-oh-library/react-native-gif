...
export namespace RNFLAnimatedImage {
  export const NAME = "RNFLAnimatedImage" as const
  ...
  export class PropsSelector extends ViewPropsSelector<Props, RawProps> {
    ...
    get contentMode() {
      return this.rawProps.contentMode ?? 0;
    }
  ...
  export interface EventPayloadByName {
    "frameChange": {currentFrameIndex: number, frameCount: number}
    "loadEnd": {size?: {width: number, height: number}}
  }
